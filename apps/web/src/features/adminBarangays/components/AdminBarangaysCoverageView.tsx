...
export default function AdminBarangaysCoverageView({ items, loading, error, busyId, q, setQ, create, update, toggleActive }: Props) {
  ...
  return (
    <>
      <div className="space-y-4 p-4 md:p-6">
        ...
        {loading && items.length === 0 ? <TableContentSkeleton label="Loading barangays" columns={["w-36", "w-24", "w-24", "w-20", "w-24"]} /> : null}
