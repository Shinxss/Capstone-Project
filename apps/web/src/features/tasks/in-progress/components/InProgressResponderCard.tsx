    ...
    <article className="rounded-xl border border-slate-200 bg-slate-50/60 p-3 dark:border-[#24324A] dark:bg-[#0E1626]">
      <div className="flex items-center gap-3">
        <div className="relative size-11 shrink-0 overflow-hidden rounded-xl bg-slate-200 dark:bg-slate-700">
          <span className="grid size-full place-items-center text-xs font-black text-slate-600 dark:text-slate-200">
            <TaskVolunteerAvatar name={volunteer?.name} avatarUrl={volunteer?.avatarUrl} imageClassName="size-full object-cover" />
          </span>
