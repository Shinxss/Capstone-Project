    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-3xl rounded-2xl bg-white shadow-lg overflow-hidden">
        <div className="p-5 border-b flex items-center justify-between">
          <div>
            <div className="text-lg font-black text-gray-900">Verified Volunteer</div>
            <div className="text-sm text-gray-600">Volunteer profile (from verified application)</div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              {!!data.reviewNotes && (
                <div className="rounded-xl border border-gray-200 p-4 lg:col-span-2">
                  <div className="text-sm font-black text-gray-900 mb-2">LGU Notes</div>
                  <div className="text-sm text-gray-800 whitespace-pre-wrap">{data.reviewNotes}</div>
                </div>
              )}
            </div>
          )}
