...
import Header from "../../components/lgu/Header";
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
      ...
      <div className="relative">
        ...
        <button className="absolute bottom-3 left-3 bg-white/90 hover:bg-white text-xs font-semibold px-3 py-2 rounded-md border border-gray-200">
          Locate Me
        </button>
      </div>
    </div>
